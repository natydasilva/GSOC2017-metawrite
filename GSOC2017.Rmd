...
This first tabset should look like this if is the first submission:

https://github.com/natydasilva/GSOC2017-metawrite/blob/master/Tab1gen.png

https://github.com/natydasilva/GSOC2017-metawrite/blob/master/tab1download.png

And at the end will be available 


https://github.com/natydasilva/GSOC2017-metawrite/blob/master/tab1version.png
